<nav class="bg-white shadow-md sticky top-0 z-50">
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
            ...
            <span class="text-2xl font-bold text-blue-700">Dusun Gayam</span>
        </div>
        ...
        <ul class="absolute left-1/2 transform -translate-x-1/2 hidden md:flex space-x-8 text-gray-600 font-medium">
            ...
            <li><a href="#" class="hover:text-blue-600 transition">Berita</a></li>
        </ul>
        ...
        <div class="relative">
            ...
            @guest
                <a href="{{ route('show-login') }}"
                   class="px-5 py-2 bg-blue-600 text-white text-sm rounded-full hover:bg-blue-700 transition font-medium">
                    Login
                </a>
            @endguest
        </div>
