        ...
        <header class="flex items-center h-20 px-6 sm:px-10 bg-white">
          ...
          <span class="sr-only">Menu</span>
            ...
            <span class="h-12 w-12 ml-2 sm:ml-3 mr-2 bg-gray-100 rounded-full overflow-hidden">
              <img src="https://img.freepik.com/free-photo/african-woman-studio-white-wall-woman-white-shirt_1157-47613.jpg?size=626&ext=jpg&ga=GA1.2.516224105.1653748033" alt="user profile photo" class="h-full w-full object-cover">
            </span>
        ...
        <main class="p-6 sm:p-10 space-y-6">
            <div class="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
                <div class="mr-6">
                    ...
                    <h2 class="text-gray-600 ml-0.5">Front End Development course</h2>
                </div>
            ...
            <section class="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
                ...
                <div class="flex flex-col row-span-3 bg-white shadow rounded-lg">
                    ...
                    <div class="p-4 flex-grow">
                        <div class="flex items-center justify-center h-full px-4 py-24 text-gray-400 text-3xl font-semibold bg-gray-100 border-2 border-gray-200 border-dashed rounded-md">To be a front end developer<br>To be a cloud engineer</div>
                    </div>
                </div>
            </section>
            <section class="text-right font-semibold text-gray-500">
                <a href="#" class="text-purple-600 hover:underline">Recreated by Mozia Precious Chibundu &#10083;</a> with <a href="https://tailwindcss.com/" class="text-teal-400 hover:underline">Tailwind CSS</a>
