  ...
  {{-- Judul Dashboard --}}
<div class="w-full max-w-md sm:-ml-2 py-2">
  <div class="flex items-center gap-3">
    <div class="h-10 w-10 bg-lime-600 text-white flex items-center justify-center rounded-md shadow-md">
      <span class="text-lg font-bold">DA</span>
    </div>
